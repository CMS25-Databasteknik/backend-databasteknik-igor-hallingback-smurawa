...
namespace Backend.Tests.Unit.Backend.Application.Modules.InPlaceLocations;
...
public class InPlaceLocationService_Tests
{
    ...
    public async Task CreateInPlaceLocationAsync_Should_Return_Success_When_Valid_Input()
    {
        ...
        mockRepo.CreateInPlaceLocationAsync(Arg.Any<InPlaceLocation>(), Arg.Any<CancellationToken>())
        ...
        await mockRepo.Received(1).CreateInPlaceLocationAsync(
    ...
    public async Task CreateInPlaceLocationAsync_Should_Return_BadRequest_When_Input_Is_Null()
    {
        ...
        await mockRepo.DidNotReceive().CreateInPlaceLocationAsync(Arg.Any<InPlaceLocation>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task CreateInPlaceLocationAsync_Should_Return_BadRequest_When_RoomNumber_Is_Zero()
    {
        ...
        Assert.Equal(400, result.StatusCode);
        Assert.Null(result.Result);
        Assert.Equal("Room number must be greater than zero.", result.Message);
    ...
    public async Task GetAllInPlaceLocationsAsync_Should_Return_All_InPlaceLocations_When_InPlaceLocations_Exist()
    {
        ...
        mockRepo.GetAllInPlaceLocationsAsync(Arg.Any<CancellationToken>())
        ...
        await mockRepo.Received(1).GetAllInPlaceLocationsAsync(Arg.Any<CancellationToken>());
    }
    ...
    public async Task GetInPlaceLocationByIdAsync_Should_Return_InPlaceLocation_When_InPlaceLocation_Exists()
    {
        ...
        mockRepo.GetInPlaceLocationByIdAsync(inPlaceLocationId, Arg.Any<CancellationToken>())
        ...
        await mockRepo.Received(1).GetInPlaceLocationByIdAsync(inPlaceLocationId, Arg.Any<CancellationToken>());
    }
    ...
    public async Task GetInPlaceLocationByIdAsync_Should_Return_BadRequest_When_InPlaceLocationId_Is_Zero()
    {
        ...
        Assert.Equal(400, result.StatusCode);
        Assert.Null(result.Result);
        Assert.Equal("In-place location ID must be greater than zero.", result.Message);

        await mockRepo.DidNotReceive().GetInPlaceLocationByIdAsync(Arg.Any<int>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task UpdateInPlaceLocationAsync_Should_Return_Success_When_Valid_Input()
    {
        ...
        mockRepo.UpdateInPlaceLocationAsync(Arg.Any<InPlaceLocation>(), Arg.Any<CancellationToken>())
        ...
        await mockRepo.Received(1).UpdateInPlaceLocationAsync(
    ...
    public async Task UpdateInPlaceLocationAsync_Should_Return_BadRequest_When_Input_Is_Null()
    {
        ...
        await mockRepo.DidNotReceive().UpdateInPlaceLocationAsync(Arg.Any<InPlaceLocation>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task DeleteInPlaceLocationAsync_Should_Return_Success_When_InPlaceLocation_Is_Deleted()
    {
        ...
        mockRepo.DeleteInPlaceLocationAsync(inPlaceLocationId, Arg.Any<CancellationToken>())
            .Returns(true);
        ...
        await mockRepo.Received(1).DeleteInPlaceLocationAsync(inPlaceLocationId, Arg.Any<CancellationToken>());
    }
    ...
    public async Task DeleteInPlaceLocationAsync_Should_Return_BadRequest_When_InPlaceLocationId_Is_Zero()
    {
        ...
        await mockRepo.DidNotReceive().DeleteInPlaceLocationAsync(Arg.Any<int>(), Arg.Any<CancellationToken>());
    }
